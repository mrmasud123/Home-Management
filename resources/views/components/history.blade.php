...
<div class="mill-contents mt-4">
    ...
    <div class="money">
        ...
        <div class="mb-3 text-center">
            <a href="{{ route('bazar.report', \Carbon\Carbon::parse($date)->format('Y-m') ) }}" class="btn btn-success" onclick="generateBazarReport()">
                    ...
                    @if (!empty($bazars))
                        ...
                        <tr class="text-center">
                            ...
                            @foreach ($members as $member)
                                ...
                                @endphp
                                <td><span class="custom-badge bg-secondary">{{ $memberExpense }}</span></td>
                            @endforeach
                            <td><span class="custom-badge bg-warning">{{ $totalExpense }}</span></td>
                        </tr>
                        ...
                        <tr class="text-center">
                            ...
                            @endforeach
                            <td>
                                <span class="custom-badge bg-success">{{ $totalGive }}</span>
                                <span class="custom-badge bg-danger">{{ $totalTake }}</span>
                            </td>
                        </tr>
